...
export const LoginPage: React.FC = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      console.log(`[Auth] Dispatching POST request to /auth/signin for ${username}...`);
      const res = await authApi.signin({
        email: username,
        password: password
      });

      console.log("[Auth] Backend sign-in succeeded:", res);
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      console.log(`[Auth] Dispatching POST request to /auth/signup for ${username}...`);
